  ...
  return (
    <div className="container-fluid">
      ...
      <section className="row mt-2">
        ...
        <main
          className="col-10 d-flex overflow-auto flex-wrap"
          style={{ height: "500px" }}
        >
          {products.map(product => (
            ...
            >
              ...
              <div className="card-body">
                <dl>
                  <dt>Price</dt>
                  <dd><span></span>{product.price.toLocaleString("en-IN", {style:'currency', currency:'INR'})}</dd>
                  <dt>Rating</dt>
                  <dd>
                    {product.rating.rate}
              ...
              <div className="card-footer">
                <button className="btn w-100 btn-warning bi bi-cart4">
                  Add to Cart
                </button>
              </div>
            </div>
